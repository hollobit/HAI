import{j as r}from"./ComposedChart.SQa0PDBz.js";import{r as o}from"./index.BW63ueOc.js";import f from"./TrendChart.BA6p-JwC.js";const g=[["rd","연구개발"],["performance","기술 성능"],["responsible","책임 있는 AI"],["economy","경제"],["science_medicine","과학·의료"],["policy","정책"],["education","교육"],["public_opinion","여론"]];function v({metrics:s}){const[i,m]=o.useState(""),[t,l]=o.useState(new Set),[c,p]=o.useState(!1),d=o.useMemo(()=>{const e=i.trim().toLowerCase();return s.filter(a=>!(c&&a.country!=="South Korea"||t.size>0&&!t.has(a.category)||e&&!(a.name_en+" "+a.name_ko+" "+a.id).toLowerCase().includes(e)))},[s,i,t,c]),u=e=>{l(a=>{const n=new Set(a);return n.has(e)?n.delete(e):n.add(e),n})};return r.jsxs("div",{children:[r.jsxs("div",{className:"filter-bar",children:[r.jsx("input",{type:"search",placeholder:"지표 검색 (한글·영문·ID)",value:i,onChange:e=>m(e.target.value),"aria-label":"지표 검색"}),r.jsxs("label",{className:"korea-toggle",children:[r.jsx("input",{type:"checkbox",checked:c,onChange:e=>p(e.target.checked)}),"🇰🇷 한국 관련만"]})]}),r.jsxs("div",{className:"cat-bar",children:[g.map(([e,a])=>r.jsx("button",{className:`cat${t.has(e)?" active":""}`,onClick:()=>u(e),type:"button",children:a},e)),t.size>0&&r.jsx("button",{className:"cat reset",onClick:()=>l(new Set),type:"button",children:"✕ 초기화"})]}),r.jsxs("div",{className:"count",children:[r.jsx("strong",{children:d.length})," / ",s.length," 지표"]}),d.length===0?r.jsx("div",{className:"empty",children:"조건에 맞는 지표가 없습니다"}):r.jsx("div",{className:"grid",children:d.map(e=>r.jsxs("article",{className:"card",children:[r.jsxs("header",{children:[r.jsx("h2",{children:e.name_ko}),r.jsx("p",{className:"en",children:e.name_en}),r.jsxs("p",{className:"meta",children:[r.jsx("span",{children:e.category}),e.country&&r.jsxs("span",{children:["· ",e.country]})]})]}),r.jsx(f,{metric:e,height:260})]},e.id))}),r.jsx("style",{children:`
